...
ns.widgets.image.prototype.addFile = function () {
	...
	if (this.params === undefined) {
		...
		html += '&nbsp;<a href="#" class="from-gallery" title="' + ns.t('core', 'addImageFromGallery') + '">' +
			'<div class="h5peditor-field-file-gallery-text"><span>' + ns.t('core', 'addFromGallery') + '</span></div></a>'
